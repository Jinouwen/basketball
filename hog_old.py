...
class Hog:
    ...
    def compute_gradient(self, img):
        ...
        if magnitude.ndim == 2:
            ...
            orientation = orientation.reshape(*orientation.shape,1)
    ...
    def compute_cell_histogram(self, img):
        ...
        for row in range(self.cell_number[0]):
            for col in range(self.cell_number[1]):
                angle = orientation[row * self.cell_size[0]:(row + 1) * self.cell_size[0], col * self.cell_size[1]:(col + 1) * self.cell_size[1]] % 180
                weight = magnitude[row * self.cell_size[0]:(row + 1) * self.cell_size[0], col * self.cell_size[1]:(col + 1) * self.cell_size[1]]
